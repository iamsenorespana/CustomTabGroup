...
/**
 Base class for all CustomTabGroup views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CustomTabGroup view hierarchy (such as wrapped iOS UIViews) was touched.
