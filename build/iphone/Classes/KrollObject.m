 ...
 * Copyright (c) 2009-2011 by CustomTabGroup, Inc. All Rights Reserved.
...
//@interface CustomTabGroupObject : NSObject
//@end

@interface CustomTabGroupObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CustomTabGroupObject class]])
		{
			for (NSString *key in [[(CustomTabGroupObject*)o modules] allKeys])
			{
