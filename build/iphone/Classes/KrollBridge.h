...
@interface CustomTabGroupObject : KrollCoverageObject {
#else
@interface CustomTabGroupObject : KrollObject {
#endif
@private
...
extern NSString * CustomTabGroup$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	CustomTabGroupObject *_customtabgroup;
    KrollObject* console;
	BOOL shutdown;
