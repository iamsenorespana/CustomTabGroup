...
//Rare exceptions to indicate a bug in the _customtabgroup code (Eg, function that a subclass should have implemented)
...
/**
 The base class for CustomTabGroup proxies.
 */
