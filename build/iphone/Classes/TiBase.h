...
// in simulator we redefine to format for CustomTabGroup Developer console
...
{\
	NSString * exceptionName = [@"org.customtabgroup." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.customtabgroup";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UICustomTabGroupNativeItemNone = -1, 
	UICustomTabGroupNativeItemSpinner = -2,
	UICustomTabGroupNativeItemProgressBar = -3,
	
	UICustomTabGroupNativeItemSlider = -4,
	UICustomTabGroupNativeItemSwitch = -5,
	UICustomTabGroupNativeItemMultiButton = -6,
	UICustomTabGroupNativeItemSegmented = -7,
	
	UICustomTabGroupNativeItemTextView = -8,
	UICustomTabGroupNativeItemTextField = -9,
	UICustomTabGroupNativeItemSearchBar = -10,
	
	UICustomTabGroupNativeItemPicker = -11,
	UICustomTabGroupNativeItemDatePicker = -12,
	
	UICustomTabGroupNativeItemInfoLight = -13,
	UICustomTabGroupNativeItemInfoDark = -14,
	
	UICustomTabGroupNativeItemDisclosure = -15,
	
	UICustomTabGroupNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CustomTabGroup instances of
