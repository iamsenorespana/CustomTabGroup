...
/**
 The base class for all CustomTabGroup modules
 */
...
/**
 CustomTabGroup Platform calls this method on startup.
 */
-(void)startup;

/**
 CustomTabGroup Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 CustomTabGroup Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 CustomTabGroup Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 CustomTabGroup Platform calls this method on resume.
 @param sender The sender of the event.
 */
